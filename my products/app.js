// import { auth, getUserProducts, onAuthStateChanged } from '../utils/utils.js';
...
//       productElement.className = 'bg-white shadow-md rounded-lg overflow-hidden w-full md:w-1/2 lg:w-1/3 xl:w-1/4 mb-4 m-2';
...
//     // Add event listeners for update and delete buttons here if needed
//   } catch (error) {
